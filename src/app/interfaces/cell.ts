...
export enum CellStatus {
  ...
  bombMarked,//правильно разминированная бомба. Отображается после окончания игры
  bombBlast,//взорванная бомба
  bombMarkedWrong,//бомба замаркированная неправильно. Иконка отображается после завершения игры
}
